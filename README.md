...
✔️ Interfaz clara e intuitiva para los empleados del restaurante.
...
🎨 Frontend con diseño adaptado basado en Bootstrap.

🔄 Uso de axios/fetch para actualización dinámica de la vista.
...
View → HTML + Thymeleaf + JS

Controller → Endpoints REST

Service → Reglas de negocio

Repository → Persistencia en MySQL
